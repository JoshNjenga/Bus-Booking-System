...
<title>Welcome to Super Metro Bus carriers</title>
...
<div id="wrapper">
	<div id="header">
    <h1><a href="index.php"><img src="xres/images/image.jpg" class="logo" alt="Super Metro" /></a></h1>
    ...
    <div id="featured">
        <div id="items">
            ...
            <p><a href="lodging.php"><strong>Odion to Thika Vice versa</strong><br />
			Spend a relaxing evening in our METRO hotel, steeped in history. </a></p>  
			</div>
	...
	<div id="footer">
	<h4>+63(2)3525393 &bull; <a href="contact-us.php"> Nairobi City, Metro Mania  </a></h4>
	<p>Hours of Operation&nbsp;&nbsp;&bull;&nbsp;&nbsp;Mon - Sun: 10:00 am - 12:00 am</p>
	<a href="index.php"><img src="xres/images/footer-logo.jpg" alt="Josh Njenga Pub and Restaurant" /></a>
	<p>&copy; Copyright 2022 Metro Bus | All Rights Reserved <br /></p>
</div>
</div>
</body>
</html>
